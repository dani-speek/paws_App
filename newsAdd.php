  ...
  <div class="container-fluid content">
    <div class="row" id="eventsPanel">
      ...
      <div class='col-md-6 col-sm-12 col-xs-12'> 
        <form class="form" action="insertNewsIntoTable.php" method="post" id="addNewsForm">
          <div class="form-group">
            <label   for="authName">Author Name:</label> <input class="form-control" type="text" name="authName" id="authName"><br>
            <label   for="authEmail">Author E-mail:</label> <input class="form-control" type="text" name="authEmail" id="authEmail"><br>
            <label  for="newsHeadline">Headline:</label> <input  class="form-control" type="text" name="newsHeadline" id="newsHeadline"><br>
            <label  for="newsStory">Story content:</label> <textarea  class="form-control noresize" type="text" name="newsStory" form="addNewsForm" id="newsStory"></textarea><br>
          </div>
          <div class="form-group">
              <input  class="btn-default" type="submit" name="createBtn" id="createBtn" value="Add News"/>
          </div> 
        </form>
    </div>
  </div>
