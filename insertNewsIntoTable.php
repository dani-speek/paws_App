...
<?php
  ...
  if ( isset($_SESSION['userName'])!="" ) {
    ...
    $type = $_SESSION['type'];
    $headlineDB = $_POST["newsHeadline"];

    $nameDB = $_POST["authName"];
    $emailDB= $_POST["authEmail"];
   // $timestampDB= timestamp;
    $storyDB= $_POST["newsStory"];

    $qry = "INSERT INTO tbnews (headline,name,email,story) VALUES ('$headlineDB','$nameDB','$emailDB','$storyDB') ";
